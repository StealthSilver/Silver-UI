        ...
        <div className="mt-8 w-full px-3 sm:px-6 md:px-10">
          ...
          >
            <p className="max-w-xl font-roboto text-base font-light leading-relaxed text-white/55 md:text-lg">
              Deconstruct is where we peel back real interfaces—components,
              layout, and patterns from other sites—so you can study how great
              products are built, not just what they look like.
            </p>
            <Link
              href="/deconstruct"
