/** Source shown in the Deconstruct code panel for VercelNavbar. */
export const vercelNavbarSource = `"use client";
  ...
  return (
    <header className="flex w-full min-h-[64px] justify-center bg-black">
      <div className="flex w-full max-w-[1448px] min-h-[64px] items-center justify-between gap-8 px-6">
        ...
        >
          <Link href="https://vercel.com/login" className={actionLinkClass}>
            Log In
          </Link>
          <Link href="https://vercel.com/contact" className={actionLinkClass}>
            Contact
          </Link>
          <Link
